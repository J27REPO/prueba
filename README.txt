...
a persistence unit "trabajo-grupoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "trabajo-grupo/pom.xml":
...
artifact ("trabajo-grupo.war") is already built. You can build
